  ...
  questions() {
    ...
    },
    {
      ...
      },
      {
        ...
        description: "MESG solves major issues in the tech and business industries.<br/><br/>These problems are as follows:<br/><br/><ul><li class='icon-list'><span></span>There is no common channel for blockchains to communicate with everyday technologies.</li><br/><li class='icon-list'><span></span>Business IT infrastructures require inefficient and costly updates to maintain old features, or accommodate new features.</li><br/><li class='icon-list'><span></span>As new technologies and devices enter the market, interoperability between these devices increasingly becomes an issue.</li><br/><li class='icon-list'><span></span>Prototyping products or features, particularly those based in blockchain, requires immense overhead and a large resource commitment, simply to test out a single technology.</li></ul><br/>We see opportunity in these issues. To solve them, we are tackling three large challenges within the business and tech industries simultaneously:<br/><br/><ul><li class='icon-list'><span></span><strong>Interoperability</strong><br/><br/><p>Effortless communication between any combination of blockchains, web and IoT.</p></li><br/><li class='icon-list'><span></span><strong>Scalability</strong><br/><br/><p>A single infrastructure from startup to multinational corporation.</p></li><br/><li class='icon-list'><span></span><strong>Efficiency</strong><br/><br/><p>Streamline business functions with set-and-forget automation.</p></li></ul>"
      }]
    },
    {
      id: "transactions",
